...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('Questions', [{
      question: 'Какая планета известна под именем утренней или вечерней звезды?',
      right_answer: 'Венера',
      score: 100,
      topic_id: 1,
    },
    ...
    {
      question: 'Как называется советский многоразовый космический корабль, по аналогу которого был построен Space Shuttle?',
      right_answer: 'Буран',
      score: 500,
      topic_id: 1,
    },
    {
      question: 'Как называется самая мощная сверхтяжелая ракета, впервые запущенная 20 апреля 2023 года?',
    ...
    {
      question: 'Этот контр – адмирал английского флота в 1806г. Предложил шкалу для оценки силы ветра. Моряки пользуются ею по ныне.',
      right_answer: 'Бофорт',
      score: 500,
      topic_id: 2,
    },
    ...
    {
      question: 'В честь этой императрицы названы были многие города России, но их переименовали, а вот городу на Урале вернули свое прежнее название. Какое? ',
      right_answer: 'Екатеринбург',
      score: 300,
      topic_id: 3,
    },
    {
      question: 'Какой древний российский город считается родиной Деда Мороза?',
      right_answer: 'Великий Устюг',
      score: 500,
      topic_id: 3,
    },
    {
      question: 'Вид и герб какого города можно увидеть на российской купюре 1000  рублей?',
    ...
    {
      question: 'Какой алкогольный напиток, по мнению ученых Мюнхенского института, в 10 раз полезнее молока?',
      right_answer: 'Пиво',
      score: 200,
      topic_id: 4,
    },
